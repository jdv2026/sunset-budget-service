...
class BudgetActiveCategoryService
{
    ...
    public function fetchByType(string $userId, string $type): \Illuminate\Database\Eloquent\Collection
    {
        return BudgetActiveCategory::where('user_id', $userId)->where('type', $type)->orderBy('name')->get();
    }
